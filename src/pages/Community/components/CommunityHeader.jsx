 ...
 * 커뮤니티 상단 영역 컴포넌트
 * - 커뮤니티 제목과 설명 표시
 * - 인기/최신/요리 후기/질문/자유 이야기 카테고리 필터 제공
    ...
    <section className={styles.communityHeader}>
      ...
      <div className={styles.categoryBar}>
        <div className={styles.category}>
          ...
          <div className={styles.categoryRow}>{categories.slice(2).map(renderCategoryButton)}</div>
        </div>
        ...
        <Button
          ...
          sx={{
            ...
            fontSize: { xs: "13px", sm: "14px" },
            boxShadow: "none",
            "&:hover": { backgroundColor: "var(--brand-primary-dark)", boxShadow: "none" },
            "& .MuiButton-startIcon": { marginRight: { xs: "4px", sm: "8px" } },
          }}
        >
          글쓰기
        </Button>
