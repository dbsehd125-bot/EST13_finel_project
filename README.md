...
| 이름       | 담당 영역                                    | 주요 담당 기능                                                                                                                 |
| ---------- | -------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| **이성희** | **메인 페이지 · 공통 컴포넌트**              | 메인 페이지 및 주요 콘텐츠 구현, Header·Footer 등 공통 컴포넌트, 주간 식단 및 추천 콘텐츠, 반응형 UI                           |
| **남윤동** | **레시피 목록 · 마이페이지**                 | 레시피 검색·필터·정렬·페이지네이션, 프로필 수정, 작성·좋아요·북마크 레시피 조회 및 관리                                        |
| **주후산** | **AI 레시피 생성 · 레시피 등록**             | 사용자 조건 기반 AI 레시피 생성, 생성 결과 연동, 단계형 레시피 등록 폼, AI 이미지 및 Storage 연동                              |
| **최정원** | **커뮤니티 · 로그인/회원가입 · 레시피 상세** | 이메일·Google·Kakao 인증, 레시피 상세 및 후기, 좋아요·북마크·조회수, 커뮤니티 CRUD·레시피 연결·무한 스크롤, 사용자 프로필 연동 |
